...
class ProjectTest extends TestCase
{
    ...
    public function it_can_broadcast_message()
    {
        ...
        $browser->shouldReceive('post')->with('/', [
            ...
            'X-Signature' => 't=1546300800,v1=3c1faf9b318b33b609f612e5e36cd5117fae4f4caf38c6141782b392ed3343d2',
        ...
        $project = new Project('foobar', ['token' => 'secret', 'signature' => 'secret'], $browser);
